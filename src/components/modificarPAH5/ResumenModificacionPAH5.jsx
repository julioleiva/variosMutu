export default class ResumenModificacionPAH5 extends React.Component {
    constructor(props) {
        super(props);
        this.SolicitarModicacion = this.SolicitarModicacion.bind(this);
    }

    SolicitarModicacion() {
        this.props.SolicitarModicacion();
    }
                    ...
                    <div className="card-body">
                        ...
                        {!this.props.isSaved &&
                            <div id="footerStep">
                                ...
                                <button className="btn-success float-right" disabled={this.props.isSaving} onClick={this.SolicitarModicacion.bind(this)}><span>Solicitar modificación</span></button>
                            </div>
                        }
                        {this.props.isSaving &&
