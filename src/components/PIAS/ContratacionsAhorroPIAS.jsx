import ValoresContratacionPIAS from "./ValoresContratacionPIAS.jsx";
...
export default class ContratacionAhorroPIAS extends React.Component {
    constructor(props) {
        super(props);
                                ...
                                disabled={
                                    !(
                                        (this.props.datosSimulacion.ApExtraordinaria > 0 &&
                                            this.props.datosSimulacion.ApExtraordinaria <= maxAportacionPIAS) ||
                                        (this.props.datosSimulacion.ApPeriodica > 0 &&
                                            this.props.datosSimulacion.ApPeriodica <= maxAportacionPIAS)
                                    )
                                }
