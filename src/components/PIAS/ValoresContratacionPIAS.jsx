...
export default class ValoresContratacionPIAS extends React.Component {
    constructor(props) {
        super(props);
        this.state = { poliza: "", isLoaded: false, error: null, startDate: moment() }
    ...
    onEndAP(event) {
        ...
        // this.CambiarPeriodicidadPorAportacion(value);
    }
                    ...
                    <div>
                        ...
                        <DayPickerInput formatDate={formatDate}
                            ...
                            placeholder={`${formatDate(
                                new Date(this.props.datosSimulacion.FechaApExtraordinaria),
                                "L",
                                "es"
                            )}`}
                ...
                <div className="dropdown-selection col-md-6 col-sm-12">
                    ...
                    <div className="select-wrapper">
                        <select className="select-dropdown"
                            value={this.props.datosSimulacion.Periodicidad}
                            onChange={this.selectPeriodicidad}
                        >
